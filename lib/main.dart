          ...
          child: Row(
            children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(logado.isPrincipal ? 'Administrador Principal (só gerencia admins)' : 'Administrador (pode editar tudo)', style: const TextStyle(color: Colors.white70, fontSize: 12)),
              ])),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              editavel ? '✅ Esta grade é editável por administradores.' : '🔒 Apenas administradores (1 e 2) podem editar esta grade.',
          ...
          children: [
            ...
            ...List.generate(10, (rowIndex) => TableRow(
              ...
              children: List.generate(8, (colIndex) => Padding(
                ...
                child: campoEditavel(controller: dirigenteControllers[rowIndex][colIndex], fontSize: 14, contentPadding: const EdgeInsets.all(12), editavelOverride: true, onChanged: () => _sincronizarLinha(rowIndex)),
              )),
            )),
          ],
        ),
